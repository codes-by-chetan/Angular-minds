...
function displayTasks() {
    ...
    for (let i =0; i < tasks.length; i++){
        ...
        todolist = `<li class="task  ${isDisabled}" id="task-${tid}">
                        ...
                        <div class="edit-this-btn" onclick="editTask(${i}, this)">
                            <i class="fa-sharp fa-solid fa-pen-to-square"></i>
                        </div>
                        <div class="delete-this-btn" onclick="removeTask(${i})">
...
function editTask(i, btn) {
    ...
    istaskcomplete = tasks[i].isCompleted;
    iscompletetext = istaskcomplete ? "checked":"";
    editEl = `<li class="edit-task-input-row">
                    ...
                    <div class="edit-save-btn" onclick="saveEditedTask(${i}, this)"><i class="fa-solid fa-floppy-disk" style="color: #000000;"></i></div>
                </li>
               `;
